    ...
    public partial class UserColumns : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TPayment__74D498AF47686B80", x => x.intPaymentMethod);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TPayment__4141EB10ACA7B817", x => x.intPaymentStatusID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TShoppin__0A3129171F137CD2", x => x.intShoppingCartID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TCartIte__4A33868DF604DCCF", x => x.intCartItemID);
                    table.ForeignKey(
                        name: "FK__TCartItem__intPr__18EBB532",
                        column: x => x.intProductID,
                        principalSchema: "db_owner",
                        principalTable: "TProducts",
                        principalColumn: "intProductID");
                    table.ForeignKey(
                        name: "FK__TCartItem__intSh__19DFD96B",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TOrders__447BBC44701D10E7", x => x.intOrderID);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK__TOrders__intUser__208CD6FA",
                        column: x => x.intUserID,
                        principalSchema: "db_owner",
                        principalTable: "TUsers",
                        principalColumn: "intUserID");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TOrderIt__33B60225C247E2F9", x => x.intOrderItemID);
                    table.ForeignKey(
                        name: "FK__TOrderIte__intOr__1EA48E88",
                        column: x => x.intOrderID,
                        principalSchema: "db_owner",
                        principalTable: "TOrders",
                        principalColumn: "intOrderID");
                    table.ForeignKey(
                        name: "FK__TOrderIte__intPr__1F98B2C1",
                        column: x => x.intProductID,
                        principalSchema: "db_owner",
                        principalTable: "TProducts",
                        principalColumn: "intProductID");
