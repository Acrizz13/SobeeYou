...
namespace sobee_core.Services {
	public class ShoppingCartService : IShoppingCartService {
		...
		public async Task ClearCartAsync(ClaimsPrincipal user) {
			...
			var promoCodeUsageHistory = _context.TPromoCodeUsageHistory.FirstOrDefault(puh => puh.ShoppingCartId == shoppingCartId);
			if (promoCodeUsageHistory != null) {
				_context.TPromoCodeUsageHistory.Remove(promoCodeUsageHistory);
			}
