...
namespace sobee_core.Services {
    public class ShoppingCartService : IShoppingCartService {
        ...
        public ShoppingCartService(SobeecoredbContext context, IHttpContextAccessor httpContextAccessor, UserManager<ApplicationUser> userManager) {
            _context = context;
        ...
        public async Task ClearCartAsync(ClaimsPrincipal user) {
            ...
            // Remove the promo code usage history associated with the shopping cart
            var promoCodeUsageHistory = _context.TpromoCodeUsageHistories.FirstOrDefault(puh => puh.IntShoppingCartId == shoppingCartId);
            if (promoCodeUsageHistory != null) {
                _context.TpromoCodeUsageHistories.Remove(promoCodeUsageHistory);
            }
